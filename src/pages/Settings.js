...
export default function Settings(props){
    ...
    const [outlookCalendarEnabled, setOutlookCalendarEnabled] = useState(OutlookCalendarEnabled)
                ...
                body : JSON.stringify({
                  ...
                  variables: {
                    input : {
                        ...
                        OutlookCalendarEnabled : outlookCalendarEnabled,
                        Movement : movement,
                        Email : email
                    }
                  }
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <ButtonGroup variant="outlined" aria-label="outlined primary button group">
                                ...
                                <Button variant={deliveryMethod == "DESKTOP_APP" ? "contained" : "outlined"} onClick={() => setDeliveryMethod("DESKTOP_APP")}>Desktop</Button>
                                {/* <Button onClick={() => setDeliveryMethod("SMS")}>SMS</Button>
                                <Button onClick={() => setDeliveryMethod("WHATSAPP")}>WhatsApp</Button> */}
                            </ButtonGroup>
                            <Typography variant="h5" component="div">
                            ...
                            <ButtonGroup orientation='vertical' variant="outlined" aria-label="outlined primary button group">
                                ...
                                {OutlookCalendarRefreshToken ?
                                    <Button variant={outlookCalendarEnabled ? "contained" : "outlined"} onClick={() => setOutlookCalendarEnabled(!outlookCalendarEnabled)}>Sync with Outlook Calendar {outlookCalendarEnabled ? "(ON)" : "(OFF)"}</Button>
                                :
                                    null
                                }
                                {/* <Button onClick={() => setDeliveryMethod("SMS")}>SMS</Button>
                        ...
                        <CardContent>
                            ...
                            <Typography variant="h6" component="div">
                                ...
                                <Typography variant="h10" component="div">
                                    Currently syncing with Outlook Calendar
                                </Typography>
                                :
                                <Typography variant="h10" component="div">
                                    Enable sync with Outlook Calendar
                                </Typography>
                                }
